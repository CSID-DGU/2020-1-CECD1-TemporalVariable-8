...
func (cc *CategoryCreate) SetOwnerID(id int) *CategoryCreate {
	cc.mutation.SetOwnerID(id)
	return cc
}

// SetOwner sets the owner edge to Restaurant.
func (cc *CategoryCreate) SetOwner(r *Restaurant) *CategoryCreate {
	return cc.SetOwnerID(r.ID)
}

// AddMenuIDs adds the menus edge to Menu by ids.
func (cc *CategoryCreate) AddMenuIDs(ids ...int) *CategoryCreate {
	cc.mutation.AddMenuIDs(ids...)
	return cc
}

// AddMenus adds the menus edges to Menu.
func (cc *CategoryCreate) AddMenus(m ...*Menu) *CategoryCreate {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return cc.AddMenuIDs(ids...)
}
...
func (cc *CategoryCreate) createSpec() (*Category, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.MenusIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
