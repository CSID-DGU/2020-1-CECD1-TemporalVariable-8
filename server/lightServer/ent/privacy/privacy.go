...
// The AuthorizeQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type AuthorizeQueryRuleFunc func(context.Context, *ent.AuthorizeQuery) error

// EvalQuery return f(ctx, q).
func (f AuthorizeQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AuthorizeQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.AuthorizeQuery", q)
}

// The AuthorizeMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type AuthorizeMutationRuleFunc func(context.Context, *ent.AuthorizeMutation) error

// EvalMutation calls f(ctx, m).
func (f AuthorizeMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.AuthorizeMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.AuthorizeMutation", m)
}
...
// The OrderFieldQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type OrderFieldQueryRuleFunc func(context.Context, *ent.OrderFieldQuery) error

// EvalQuery return f(ctx, q).
func (f OrderFieldQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.OrderFieldQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.OrderFieldQuery", q)
}

// The OrderFieldMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type OrderFieldMutationRuleFunc func(context.Context, *ent.OrderFieldMutation) error

// EvalMutation calls f(ctx, m).
func (f OrderFieldMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.OrderFieldMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.OrderFieldMutation", m)
}
